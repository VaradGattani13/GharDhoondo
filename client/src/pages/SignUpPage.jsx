...
const SignUpPage = () => {
  ...
  return (
    <section>
    <h1 className='text-3xl text-center mt-6 font-bold'>Sign Up page</h1>
      ...
      <div  className='w-full md:w-[67%] lg:w-[40%] ml-20 rounded'>
        ...
        <input
            ...
            <div className='flex justify-between text-sm'>
              <p className='mb-8 mt-4 '>Already Have An Account? 
              <Link to='/signin' className='text-red-500 hover:text-purple-700'> Click Here</Link></p>
